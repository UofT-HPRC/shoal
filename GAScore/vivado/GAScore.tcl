proc create_GAScore {bd_name} {
  ...
  set_property -dict [list CONFIG.FIFO_DEPTH {2048}] $axis_data_fifo_1

  set axis_data_fifo_2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_data_fifo:1.1 axis_data_fifo_2 ]
  set_property -dict [list CONFIG.FIFO_DEPTH {2048}] $axis_data_fifo_2
  ...
  connect_bd_intf_net [get_bd_intf_pins axis_data_fifo_2/M_AXIS] [get_bd_intf_pins axi_datamover_0/S_AXIS_S2MM_CMD]
  connect_bd_intf_net [get_bd_intf_pins axis_data_fifo_2/S_AXIS] [get_bd_intf_pins am_rx_0/axis_s2mmCommand_V_data_V]
  connect_bd_intf_net [get_bd_intf_pins axis_data_fifo_1/M_AXIS] [get_bd_intf_pins axi_datamover_0/S_AXIS_MM2S_CMD]
  connect_bd_intf_net [get_bd_intf_pins axis_data_fifo_1/S_AXIS] [get_bd_intf_pins am_tx_0/axis_mm2sCommand_V_data_V]
  ...
  connect_bd_intf_net [get_bd_intf_ports axis_kernel_in] [get_bd_intf_pins axis_data_fifo_0/S_AXIS]
  connect_bd_intf_net [get_bd_intf_pins axis_data_fifo_0/M_AXIS] [get_bd_intf_pins xpams_tx_0/axis_kernel_in]
