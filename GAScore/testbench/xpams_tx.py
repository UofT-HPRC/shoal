...
axis_kernel_in.writes(smA_t1, [
    {"tdata": strToInt("{AMHeader,0x01,0x02,0,0,0x41,0}")},
...
axis_kernel_in.writes(mmA_t1, [
    {"tdata": strToInt("{AMHeader,0x01,0x2,0x100,0x0,0x2,0}")},
...
axis_kernel_in.writes(lmA_t1, [
    {"tdata": strToInt("{AMHeader,0x01,0x11,0xC,1,0x5,2}")},
...
lmA_t2 = Thread()
axis_tx.read(lmA_t2, strToInt("{AMHeader,0x01,0x11,0xC,1,0x5,2}"))
