...
axis_handler.read(smB_t4, strToInt("{AMHeader,0,0x01,0,0x1,0x1,1}"))
...
axis_handler.read(smB_t4, strToInt("{AMHeader,0,0x00,0,0x1,0x1,1}"))
...
mmA_t2 = Thread()
axis_kernel_out.read(mmA_t2, strToInt("{AMHeader,0,0xAA,0x800,0x0,0x2,0}"), tdest=2)
for i in range(255):
...
axis_handler.read(lmA_t2, strToInt("{AMHeader,2,0x2,0x60,1,0x5,2}"))
