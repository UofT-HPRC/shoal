...
smA_t2.wait_level("interrupt_0 == $value", value=0)
ctrl_bus_0.write(smA_t2, 'config', 0)

smA_t3 = short_message_A.add_thread()
smA_t3.wait_level("interrupt_1 == $value", value=1)
ctrl_bus_1.write(smA_t3, 'config', 1)
smA_t3.wait_level("interrupt_1 == $value", value=0)
ctrl_bus_1.write(smA_t3, 'config', 0)
