...
ctrl_bus_0.port.init_channels(mode='default', dataWidth=32, addrWidth=5)
...
ctrl_bus_1.port.init_channels(mode='default', dataWidth=32, addrWidth=5)
...
smA_t1.init_timer()
ctrl_bus_0.write(smA_t1, 'counter_threshold', 4)
ctrl_bus_0.write(smA_t1, 'counter_reset', 1)
ctrl_bus_1.write(smA_t1, 'counter_threshold', 4)
ctrl_bus_1.write(smA_t1, 'counter_reset', 1)
axis_handler.write(smA_t1, strToInt("{AMHeader,0xAA,0x1,0xC,1,0x5,2}"))
axis_handler.write(smA_t1, 5, tlast=1)
axis_handler.write(smA_t1, strToInt("{AMHeader,0xAA,0x0,0xC,1,0x5,2}"))
axis_handler.write(smA_t1, 5, tlast=1)
short_message_A.add_thread(smA_t1)

smA_t2 = short_message_A.add_thread()
smA_t2.wait_level("interrupt_0 == $value", value=1)
ctrl_bus_0.write(smA_t2, 'counter_threshold', 2)
ctrl_bus_0.write(smA_t2, 'counter_reset', 1)

smA_t3 = short_message_A.add_thread()
smA_t3.wait_level("interrupt_0 == $value", value=1)
ctrl_bus_1.write(smA_t3, 'counter_threshold', 2)
ctrl_bus_1.write(smA_t3, 'counter_reset', 1)
