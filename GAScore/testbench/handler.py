...
smB_t1.add_delay('100ns')
smB_t1.init_timer()
smB_t1.set_signal('AMhandler_V', 1)
ctrl_bus.write(smB_t1, 'config', 2)
axis_handler.write(smB_t1, 0, tlast=1)
axis_handler.write(smB_t1, 0, tlast=1, callTB=2)
smB_t1.wait_level('interrupt_V == $value', value=1)
ctrl_bus.write(smB_t1, 'config', 0)
smB_t1.print_elapsed_time("short_message_B")
smB_t1.end_vector()
short_message_B.add_thread(smB_t1)
