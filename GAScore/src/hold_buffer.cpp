...
static void read(axis_t &axis_input, axis_t &axis_output){
    #pragma HLS PIPELINE
    axis_word_t axis_word;
    axis_input.read(axis_word);
    axis_output.write(axis_word);
...
static void write(axis_t &axis_input, axis_t &axis_output, uint_1_t &dataRelease){
    #pragma HLS PIPELINE
    axis_word_t axis_word;
    if(dataRelease){
        axis_input.read(axis_word);
...
void hold_buffer(axis_t &axis_input, axis_t &axis_output, uint_1_t &dataRelease){
    #pragma HLS INTERFACE axis port=axis_input
    #pragma HLS INTERFACE axis port=axis_output
    #pragma HLS INTERFACE ap_stable port=dataRelease
    #pragma HLS INTERFACE ap_ctrl_none port=return
