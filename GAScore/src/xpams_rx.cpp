...
void xpams_rx(
    ...
    switch(currentState){
        ...
        case st_AMToken:{
            if(!axis_rx.empty() && !axis_tx.full() && !axis_handler.full()){
        ...
        case st_AMhandlerArgs:{
            if(!axis_rx.empty() && !axis_handler.full()){
        ...
        case st_AMpayload:{
            ...
            if(!axis_rx.empty() && !axis_kernel_out.full()){
            axis_rx.read(axis_word);
