...
#define AM_STRIDE_BLK_SIZE_UPPER 31
#define AM_STRIDE_BLK_NUM_LOWER 32
#define AM_STRIDE_BLK_NUM_UPPER 47
...
// Reply
#define AM_REPLY_TYPE_UPPER 7
#define AM_REPLY_TYPE_LOWER 0
#define AM_REPLY_TOKEN_UPPER 23
#define AM_REPLY_TOKEN_LOWER 8
#define AM_REPLY_ADDR_UPPER 39
#define AM_REPLY_ADDR_LOWER 24
#define AM_REPLY_PAYLOAD_SIZE_UPPER 55
#define AM_REPLY_PAYLOAD_SIZE_LOWER 40
#define AM_REPLY_HANDLER_UPPER 59
#define AM_REPLY_HANDLER_LOWER 56
#define AM_REPLY_HANDLER_ARGS_UPPER 63
#define AM_REPLY_HANDLER_ARGS_LOWER 60
...
// Reply
#define AM_REPLY_PAYLOAD_SIZE AM_REPLY_PAYLOAD_SIZE_UPPER,AM_REPLY_PAYLOAD_SIZE_LOWER
#define AM_REPLY_ADDR AM_REPLY_ADDR_UPPER,AM_REPLY_ADDR_LOWER
#define AM_REPLY_HANDLER AM_REPLY_HANDLER_UPPER,AM_REPLY_HANDLER_LOWER
#define AM_REPLY_TYPE AM_REPLY_TYPE_UPPER,AM_REPLY_TYPE_LOWER
#define AM_REPLY_HANDLER_ARGS AM_REPLY_HANDLER_ARGS_UPPER,AM_REPLY_HANDLER_ARGS_LOWER
#define AM_REPLY_TOKEN AM_REPLY_TOKEN_UPPER,AM_REPLY_TOKEN_LOWER
...
#define AM_REPLY_PAYLOAD_SIZE_WIDTH (AM_REPLY_PAYLOAD_SIZE_UPPER-AM_REPLY_PAYLOAD_SIZE_LOWER+1)
#define AM_REPLY_ADDR_WIDTH (AM_REPLY_ADDR_UPPER-AM_REPLY_ADDR_LOWER+1)
#define AM_REPLY_HANDLER_WIDTH (AM_REPLY_HANDLER_UPPER-AM_REPLY_HANDLER_LOWER+1)
#define AM_REPLY_TYPE_WIDTH (AM_REPLY_TYPE_UPPER-AM_REPLY_TYPE_LOWER+1)
#define AM_REPLY_HANDLER_ARGS_WIDTH (AM_REPLY_HANDLER_ARGS_UPPER-AM_REPLY_HANDLER_ARGS_LOWER+1)
#define AM_REPLY_TOKEN_WIDTH (AM_REPLY_TOKEN_UPPER-AM_REPLY_TOKEN_LOWER+1)
...
#define AM_REPLY_PAYLOAD_SIZE_BITMASK ((power_64<2,AM_REPLY_PAYLOAD_SIZE_WIDTH>()-1) << AM_REPLY_PAYLOAD_SIZE_LOWER)
#define AM_REPLY_ADDR_BITMASK ((power_64<2,AM_REPLY_ADDR_WIDTH>()-1) << AM_REPLY_ADDR_LOWER)
#define AM_REPLY_HANDLER_BITMASK ((power_64<2,AM_REPLY_HANDLER_WIDTH>()-1) << AM_REPLY_HANDLER_LOWER)
#define AM_REPLY_TYPE_BITMASK ((power_64<2,AM_REPLY_TYPE_WIDTH>()-1) << AM_REPLY_TYPE_LOWER)
#define AM_REPLY_HANDLER_ARGS_BITMASK ((power_64<2,AM_REPLY_HANDLER_ARGS_WIDTH>()-1) << AM_REPLY_HANDLER_ARGS_LOWER)
#define AM_REPLY_TOKEN_BITMASK ((power_64<2,AM_REPLY_TOKEN_WIDTH>()-1) << AM_REPLY_TOKEN_LOWER)
