 ...
 * Willenberg. It contains platform specific definitions and includes headers.
 *
...
#define PRINTACCTIME(COND,TEXT,SECVAR,USECVAR)		\
    ...
    typedef unsigned int gasnet_token_t;
    typedef long long gasnet_handlerarg_t;
    typedef gasnet_handlerarg_t garg;
