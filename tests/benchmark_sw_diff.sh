...
# make lib DEBUG=0
python tests/benchmark_data.py --test all --payload_min 0 --payload_max 10 --iterations 10000 latency
...
# make galapagos-benchmark K_START=0 K_END=2 MODE=x86 KERN_BUILD=1 DEBUG=0
